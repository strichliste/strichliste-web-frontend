...
describe('ArticleValidator', () => {
  describe('validates a user that buys article', () => {
    it('is valid if user has enough balance', () => {
      ...
      renderWithContext(<ArticleValidator value={8} userId={'1'} render={mockRender} />, { users: { '1': { balance: 10 } } }
      );
    ...
    it('is invalid if user has not enough balance', () => {
      const mockRender = vi.fn();
      renderWithContext(<ArticleValidator value={2010} userId={'1'} render={mockRender} />, { users: { '1': { balance: 10 } } }
      );
