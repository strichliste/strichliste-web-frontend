export const en = {
  ...
  CANCEL: 'Cancel',
  DIALOG: 'Dialog',
  ROUTE_TITLE_USER: 'User',
  ROUTE_TITLE_USERS: 'Users',
  ROUTE_TITLE_ARTICLES: 'Articles',
  ROUTE_TITLE_SEARCH: 'Search',
  BALANCE_DISPENSE: 'dispense',
  BALANCE_PLACEHOLDER: 'CUSTOM AMOUNT',
  BALANCE_DEPOSIT: 'deposit',
  BALANCE_TITLE: 'Balance',
  BALANCE_SIGN_POSITIVE: 'positive balance: ',
  BALANCE_SIGN_NEGATIVE: 'negative balance: ',
  BALANCE_SIGN_ZERO: 'zero balance: ',
